...
<Info>
  **Prérequis** : Il est recommandé d'avoir lu la leçon sur les [Tokens et Embeddings](/fondamentaux/tokens-et-embeddings) avant d'aborder la fenêtre de contexte.
</Info>
...
| Llama 4 Maverick (Meta) | 1 000 000 tokens | ~750 000 mots / ~1 500 pages |
| Llama 4 Scout (Meta) | jusqu'à 10 000 000 tokens | ~7,5 millions de mots / ~15 000 pages |
