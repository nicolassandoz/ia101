...
Les tailles varient considérablement d'un modèle à l'autre et évoluent rapidement. Voici un aperçu de capacités représentatives, vérifiées le **25 septembre 2026** :

| Modèle | Fenêtre de contexte | Équivalent approximatif |
|---|---|---|
| GPT-6 Astra (OpenAI) | ~1 000 000 tokens | ~750 000 mots / ~1 500 pages |
| GPT-5.6 (OpenAI, génération précédente) | ~1 000 000 tokens | ~750 000 mots / ~1 500 pages |
| Claude Fable 5.1 (Anthropic) | 1 000 000 tokens | ~750 000 mots / ~1 500 pages |
| Claude Opus 5.5 / Claude Sonnet 5 (Anthropic) | 1 000 000 tokens | ~750 000 mots / ~1 500 pages |
...
| Gemini 3.8 Flash (Google) | 1 000 000 tokens | ~750 000 mots / ~1 500 pages |
| DeepSeek V4 (DeepSeek, poids ouverts) | 1 000 000 tokens | ~750 000 mots / ~1 500 pages |
| Kimi K3 (Moonshot AI, poids ouverts) | 1 048 576 tokens | ~786 000 mots / ~1 570 pages |
| Grok 4.7 (xAI) | 500 000 tokens | ~375 000 mots / ~750 pages |
...
<Note>
  Ces limites indiquent une capacité maximale, pas une qualité uniforme sur toute la longueur. Vérifiez toujours la documentation du modèle utilisé : [Claude](https://platform.claude.com/docs/en/models/overview), [Gemini 3.8 Flash](https://deepmind.google/models/model-cards/gemini-3-8-flash/) et [Grok](https://docs.x.ai/developers/models).
</Note>
