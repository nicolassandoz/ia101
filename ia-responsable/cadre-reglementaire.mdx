...
<CardGroup cols={2}>
  ...
  <Card title="Normes harmonisées européennes" icon="flag">
    Le CEN-CENELEC a approuvé le 12 juillet 2026 la norme **EN 18286:2026**, premier standard harmonisé publié en soutien à l'AI Act : elle couvre le système de management de la qualité exigé par l'article 17 pour les systèmes à haut risque. Elle n'est toutefois pas encore citée au Journal officiel de l'UE, donc aucune présomption de conformité (article 40) ne lui est encore attachée. D'autres normes sont encore en cours d'élaboration.
  </Card>
</CardGroup>
