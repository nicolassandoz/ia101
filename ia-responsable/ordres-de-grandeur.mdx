...
<Info>
  **Niveau** : Intermédiaire · **Prérequis** : [Empreinte environnementale de l'IA](/ia-responsable/empreinte-environnementale) · **Temps de lecture** : ~6 min
</Info>
...
<Accordion title="Quiz : Google annonce 0,03 gCO₂e par requête médiane, Mistral 1,14 gCO₂e pour une réponse de 400 tokens, soit un facteur 40. L'un des deux fournisseurs communique-t-il un chiffre trompeur ?">
