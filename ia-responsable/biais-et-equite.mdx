...
<Info>
  **Niveau** : Intermédiaire · **Prérequis** : [Impact cognitif](/ia-responsable/impact-cognitif) · **Temps de lecture** : ~6 min
</Info>
...
<Accordion title="Quiz : Un modèle qui associe majoritairement « médecin » au masculin est-il forcément défaillant et à corriger en priorité ?">
