...
- [x] ~~Surveillance : OpenAI a révélé le nom "Astra" pour son prochain modèle majeur~~ → Astra confirmé et sorti sous le nom GPT-6 Astra le 03/09/2026, devient le modèle phare d'OpenAI (GPT-5.6 reste disponible en parallèle). Références mises à jour par `pedagogue-ia101` (2026-09-07) dans `fondamentaux/modeles-de-langage.mdx`, `fondamentaux/types-dia.mdx`, `fondamentaux/tokens-et-embeddings.mdx`, `prompt-engineering/chain-of-thought.mdx`, `context-engineering/fenetre-de-contexte.mdx`, `ressources/outils-et-plateformes.mdx`, `ressources/glossaire.mdx`
- [x] ~~Ajouter Qwen (Alibaba) aux références du cours~~ → Qwen3.8-Max ajouté par `pedagogue-ia101` (2026-09-21) dans `context-engineering/fenetre-de-contexte.mdx`, `fondamentaux/modeles-de-langage.mdx`, `ressources/glossaire.mdx`, `ressources/outils-et-plateformes.mdx`
- [x] ~~Mettre à jour xAI en SpaceXAI suite au rachat par SpaceX~~ → corrigé par `pedagogue-ia101` (2026-09-21) dans `fondamentaux/modeles-de-langage.mdx`, `context-engineering/fenetre-de-contexte.mdx`, `ressources/glossaire.mdx`. Sources secondaires convergentes seulement (accès direct à x.ai et Wikipédia bloqué depuis cet environnement) : reconfirmer via une source primaire dès que l'accès est possible
- [ ] Reconfirmer EN 18286:2026 dès sa citation au Journal officiel de l'UE (présomption de conformité au sens de l'article 40) : la norme est approuvée par le CEN-CENELEC depuis le 12/07/2026 mais pas encore publiée au JOUE (constaté le 2026-09-21, `ia-responsable/cadre-reglementaire.mdx`)
- [ ] À VÉRIFIER, ne pas ajouter tant que non confirmé : Qwen3.8-Omni-Flash (Alibaba), repéré dans une seule source de synthèse non officielle lors de la veille du 2026-09-21. Ne pas publier sans recoupement avec une source primaire ou au moins deux sources indépendantes
