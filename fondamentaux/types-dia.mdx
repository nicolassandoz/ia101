...
<Tabs>
  ...
  <Tab title="LLM">
    ...
    ### Les LLM les plus connus en 2024–2025

    | Modèle | Organisation | Particularité |
    |---|---|---|
    | **GPT-4o** | OpenAI | Multimodal (texte, image, audio) |
    | **Claude 3.5 / 3.7** | Anthropic | Contexte très long, sécurité avancée |
    | **Gemini 1.5 Pro** | Google DeepMind | Fenêtre de contexte d'1 million de tokens |
    | **LLaMA 3** | Meta | Open source, déployable localement |
    | **Mistral Large** | Mistral AI | Français, open source, efficace |
