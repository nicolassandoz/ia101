...
Le test de Turing a été conçu en 1950 comme un critère opérationnel d'intelligence. Des systèmes conversationnels modernes peuvent tromper des évaluateurs dans certains protocoles contrôlés. Le résultat dépend toutefois de la durée de l'échange, des consignes et des critères retenus. Réussir ce test ne démontre donc ni une intelligence générale, ni une pensée comparable à celle d'un humain.
