...
**2. La limite de contexte** : chaque modèle a une **fenêtre de contexte maximale**, exprimée en tokens. GPT-5.6 et Claude Sonnet 5 supportent chacun environ 1 million de tokens ; Claude Haiku 4.5 se limite à 200 000 tokens. Au-delà, le modèle ne peut plus "voir" les informations les plus anciennes de la conversation.
