...
<CardGroup cols={2}>
  <Card title="GPT-6 Astra" icon="robot" href="https://openai.com">
    Développé par **OpenAI**, GPT-6 Astra est depuis septembre 2026 le modèle le plus capable de la gamme, avec une fenêtre de contexte d'environ un million de tokens. Il intègre texte, images et audio dans un seul modèle multimodal. GPT-5.6, la génération précédente, reste disponible en parallèle.
  </Card>
  <Card title="Claude" icon="sparkles" href="https://anthropic.com">
    Développé par **Anthropic**, Claude est réputé pour ses longues fenêtres de contexte, sa capacité de raisonnement et son alignement sur des valeurs de sécurité. Claude Fable 5.1 est aujourd'hui le modèle phare de la gamme, avec Claude Opus 5 comme alternative plus économique.
  </Card>
  ...
  <Card title="Mistral, Llama, DeepSeek & Qwen" icon="code" href="https://mistral.ai">
    **Mistral** (français) et **DeepSeek** (chinois) proposent des modèles **open-source** ou à poids ouverts, particulièrement appréciés pour leur déploiement local et leur transparence. DeepSeek V4, publié sous licence MIT, illustre la montée en puissance de ces alternatives ouvertes face aux modèles propriétaires. **Moonshot AI**, une autre entreprise chinoise, a rejoint ce mouvement en juillet 2026 avec **Kimi K3**, un modèle à poids ouverts de 2,8 billions de paramètres publié sous licence Modified MIT. **Alibaba** a franchi une étape similaire en août 2026 avec **Qwen3.8-Max** : un modèle à poids ouverts de 2,4 billions de paramètres (95 milliards actifs grâce à son architecture MoE), doté d'une fenêtre de contexte d'un million de tokens et nativement multimodal, dont les poids ont été publiés sur Hugging Face le 12 août 2026. Meta a longtemps suivi cette voie avec sa famille **Llama**, toujours téléchargeable, mais met désormais en avant **Muse Spark**, un modèle propriétaire à poids fermés devenu la vitrine du groupe depuis avril 2026. En août 2026, Meta a toutefois réintroduit un modèle à poids ouverts, **Muse Glimmer**, sous licence Apache 2.0, aux côtés de Muse Spark.
  </Card>
  <Card title="Grok" icon="bolt" href="https://x.ai">
    Développé par **SpaceXAI** (ex-xAI, après le rachat par SpaceX et le rebrand de juillet 2026), Grok est intégré à la plateforme X et mise sur un accès à l'information en temps réel. Grok 4.6, sorti en août 2026, est son modèle phare, orienté raisonnement et code.
  </Card>
</CardGroup>
