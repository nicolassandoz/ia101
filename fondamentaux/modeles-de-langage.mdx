...
**Les couches et les paramètres** sont les "neurones" du modèle. Un LLM comme GPT-4 possède des centaines de milliards de paramètres : des valeurs numériques ajustées lors de l'entraînement pour encoder les connaissances du modèle.
...
<CardGroup cols={2}>
  <Card title="GPT-4 / GPT-4o" icon="robot" href="https://openai.com">
  ...
  <Card title="Mistral & Llama" icon="code" href="https://mistral.ai">
...
| Exemple | GPT-4 base | GPT-4o, Claude 3, Gemini Pro |
