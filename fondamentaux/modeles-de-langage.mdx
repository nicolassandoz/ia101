...
<CardGroup cols={2}>
  ...
  <Card title="Mistral, Llama & DeepSeek" icon="code" href="https://mistral.ai">
    **Mistral** (français), **Llama** (Meta) et **DeepSeek** (chinois) proposent des modèles **open-source** ou à poids ouverts, particulièrement appréciés pour leur déploiement local et leur transparence. DeepSeek V4, publié sous licence MIT, illustre la montée en puissance de ces alternatives ouvertes face aux modèles propriétaires.
  </Card>
  <Card title="Grok" icon="bolt" href="https://x.ai">
    Développé par **xAI**, Grok est intégré à la plateforme X et mise sur un accès à l'information en temps réel. Grok 4.5, sorti en juillet 2026, est son modèle phare, orienté raisonnement et code.
  </Card>
</CardGroup>
