...
<CardGroup cols={2}>
  ...
  <Card title="Qwen (Alibaba)" icon="code" href="https://qwen.ai">
    **Alibaba Cloud Model Studio** (API **DashScope**) donne accès à Qwen3.8-Max, un modèle MoE de 2,4 billions de paramètres (95 milliards actifs) en disponibilité générale depuis le 3 août 2026, avec une fenêtre de contexte d'1 million de tokens et un support multimodal natif. Ses poids ont été publiés sur Hugging Face le 12 août 2026.
  </Card>
