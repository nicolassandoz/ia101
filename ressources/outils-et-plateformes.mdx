...
| Votre besoin | Point de départ recommandé | Pourquoi |
|---|---|---|
| Tester des prompts sans coder | ChatGPT, Claude ou Gemini | Interface immédiate, fichiers et outils intégrés |
| Intégrer un modèle dans une application | API du fournisseur déjà utilisé par votre organisation | Moins de comptes, de contrats et de données dispersées |
| Construire un RAG | LlamaIndex ou Haystack + une base vectorielle | Pipelines d'ingestion et de recherche explicites |
| Orchestrer un agent ou un workflow | LangGraph ou Microsoft Agent Framework | État, transitions et observabilité mieux maîtrisés |
| Comparer la qualité en production | Braintrust ou LangSmith | Jeux d'évaluation, traces et comparaison de versions |

<Tip>
  Ne choisissez pas un outil uniquement sur une démonstration. Testez-le sur **10 à 30 cas réels**, avec vos critères de qualité, de coût, de confidentialité et de réversibilité.
</Tip>
...
<CardGroup cols={2}>
  <Card title="ChatGPT" icon="comment-dots" href="https://chat.openai.com">
    L'interface conversationnelle d'OpenAI, donnant accès à la famille GPT-6, dont Astra, Sol et Luna selon l'offre et le déploiement en cours.
  </Card>
  <Card title="Claude" icon="robot" href="https://claude.ai">
    L'assistant d'Anthropic basé sur les modèles Claude Fable 5.1, Opus 5.5, Sonnet 5 et Haiku 4.5, reconnu pour ses longues fenêtres de contexte.
  </Card>
...
<CardGroup cols={2}>
  <Card title="OpenAI API" icon="code" href="https://platform.openai.com">
    L'API d'OpenAI donne accès à GPT-6 Astra, Sol et Luna, ainsi qu'aux modèles spécialisés pour l'audio et l'image.
  </Card>
  <Card title="Anthropic API" icon="code" href="https://console.anthropic.com">
    L'API d'Anthropic expose Claude Fable 5.1, Opus 5.5, Sonnet 5 et Haiku 4.5. Les trois premiers acceptent jusqu'à 1 million de tokens de contexte.
  </Card>
  ...
  <Card title="DeepSeek API" icon="code" href="https://platform.deepseek.com">
  ...
  <Card title="Moonshot AI (Kimi)" icon="code" href="https://github.com/MoonshotAI/Kimi-K3">
...
<CardGroup cols={2}>
  ...
  <Card title="Microsoft Agent Framework" icon="microsoft" href="https://learn.microsoft.com/en-us/agent-framework/overview/">
    Le successeur direct d'AutoGen et de Semantic Kernel réunit leurs abstractions d'agents, la gestion d'état et des workflows en graphe. Il existe en Python, .NET et Go.
  </Card>
</CardGroup>

<Note>
  **Sélection vérifiée le 25 septembre 2026.** Les modèles, tarifs et niveaux gratuits changent vite. Consultez la documentation officielle avant un choix de production.
</Note>
...
<CardGroup cols={2}>
  <Card title="Microsoft Foundry" icon="microsoft" href="https://azure.microsoft.com/en-us/products/ai-foundry">
