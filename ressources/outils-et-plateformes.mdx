...
<CardGroup cols={2}>
  ...
  <Card title="Claude" icon="robot" href="https://claude.ai">
    L'assistant d'Anthropic basé sur les modèles Claude Fable 5, Opus 5, Sonnet 5 et Haiku 4.5, reconnu pour ses longues fenêtres de contexte et sa sécurité renforcée.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Anthropic API" icon="code" href="https://console.anthropic.com">
    L'API d'Anthropic expose les modèles Claude Fable 5, Opus 5, Sonnet 5 et Haiku 4.5, avec des capacités de contexte étendu (jusqu'à 1 million de tokens pour Fable 5, Opus 5 et Sonnet 5) et un focus sur la sécurité et l'alignement.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Microsoft Agent Framework" icon="microsoft" href="https://learn.microsoft.com/en-us/agent-framework/overview/agent-framework-overview">
