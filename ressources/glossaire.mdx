...
<AccordionGroup>
  ...
  <Accordion title="LLM (Large Language Model)">
    Un **LLM** (grand modèle de langage) est un modèle de réseau de neurones entraîné sur des corpus de texte massifs pour comprendre et générer du langage naturel. Ils sont basés sur l'architecture Transformer et comptent des milliards voire des billions de paramètres. GPT-5.6, Claude Sonnet 5, Gemini 3.1 Pro, Muse Spark (Meta), DeepSeek V4 et Grok 4.6 (xAI) sont parmi les LLM les plus connus.
  </Accordion>
